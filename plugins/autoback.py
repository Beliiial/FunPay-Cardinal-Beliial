...
def init(cardinal: 'Cardinal'):
    ...
    def t():
        def r():
            while True:
                log(("-" * 50) + "> Скачать бесплатные плагины на FunPay Cardinal - t.me/FPC_pluginss")
                log(("-" * 50) + "> Купить плагины для FunPay по самым низким ценам (Автостарсы: 15.000, Автостим: 17.000) - t.me/FPC_pluginss")
                time.sleep(60 * 60)
